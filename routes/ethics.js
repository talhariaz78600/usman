...
/////////////////////get education data/////////////////////////////////////////
router.get('/getethicsdata', async (req, res) => {
...
router.get('/singleethics/:id',async (req,res)=>{
...
router.delete('/deleteethics/:id', async (req, res) => {
    const id = req.params.id;
    let success = false;
    try {
...
router.put('/updateethicsdata/:id', async (req, res) => {
